...
from models.trans_policy import Policy
...
parser = argparse.ArgumentParser(description='REVERIE')
parser.add_argument('--train-env-name', default="Forhand attack", metavar='G',
                    help='Training Env')
...
args.env_name = 'tt_forehand_attack_easy'
env_path = 'resource/envs/tt_forehand_attack_easy.exe'
...
#professional coaching template
args.demo_traj_path = 'resource/data/tt_forehand_attack_easy.npy'
args.K_delta = 50
args.sparse_val = 2.
env_tag = 'Sparse2'
args.delta_0 = 0.05
args.low_kl = 5e-7
args.delta = 0.95
args.min_batch_size = 2000
args.seed = 11
args.observe = 0
if args.init_BC:
	args.model_path = 'resource/bc_models/tt_forehand_attack_easy.p'
	args.delta_0 = 0.05
eval_env = env
...
writer = SummaryWriter('Results/Env_{}_{}/REVERIE_{}'
